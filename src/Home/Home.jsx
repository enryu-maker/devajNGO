    ...
    return (
        <SafeAreaView className=' justify-start items-center h-full bg-white'>
            <Header
                ...
                title={"Home"} />
            <ScrollView
                className='h-full w-full mb-[100px] bg-transparent'
            >
                <Image
                    source={Images?.banner}
                    className='h-[580px] w-[95%] rounded-[8px] object-contain self-center'
                />
                <Image
                    source={Images?.login}
                    className='h-[280px] w-[95%] mt-5 rounded-[8px] self-center'
                />
                <View
